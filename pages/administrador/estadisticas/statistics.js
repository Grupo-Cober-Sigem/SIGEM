...
const seguimientosaprobados = {
    ...
    data: [5000], // La data es un arreglo que debe tener la misma cantidad de valores que la cantidad de etiquetas
...
const seguimientosporrevisar = {
    ...
    data: [10000], // La data es un arreglo que debe tener la misma cantidad de valores que la cantidad de etiquetas
